...
const EN: any = {
  ...
  CVNNHint:'综合考虑聚类类别间紧密度与可分割性的指标，一般该值越小说明模型效果越好。',
  TheNumberofClustersHint:'TheNumberofClustersHint',
  squaredHint:'样本总体方差与聚类类别内方差和的差值占样本总体方差的比例，在聚类类别数一定的情况下，一般该值越大说明模型效果越好。',
  SihouetteScoreHint:'样本总体轮廓系数的均值，一般该值越大说明模型效果越好。',
