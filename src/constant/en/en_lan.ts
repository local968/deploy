...
const EN_LAN = {
  ...
  Less: 'less',
  More: 'more',
  Thantwouniquealues: ' more than two categories',
  ...
  cannotDeploy: 'Tip: The model you have selected does not support deployment.',
  ...
  Variableneedstostartwith: 'Var-Select a continuous variable; the variable needs to start with @. [range_list1], [range_list2]. -Custom variable partition range; the first value should be greater than the minimum value of the variable, and the last value should be less than the maximum value of the variable; the length of the range_list determines the number of groups.',
  ...
  AssociationHint: 'For discovering regularities between products in transaction/user - product data.',
  AssociationSchemaTitle: 'Please select user/transaction ID variable and item ID variable.',
  AssociationTarget: 'User ID',
  AssociationVariable: 'Item ID',
  AssociationAP: 'Apriori',
  AssociationFP: 'Fp Tree',
  AssociationAPSupport: 'Minimum Support',
  AssociationAPConfidence: 'Minimum Confidence',
  AssociationAPLift: 'Minimum Lift',
  AssociationAPLength: 'Max Length',
  AssociationAPSupportHint: 'support（{x→y}）= transactions containing both x and y / total number of transactions',
  AssociationAPConfidenceHint: 'confidence（{x→y}）= transactions containing both x and y / transactions containing x',
  AssociationAPLiftHint: 'lift（{x→y}） = confidence（{x→y}）/ transactions containing y',
  AssociationAPLengthHint: 'Maximum length of item sets',
  AssociationFPSupport: 'Support Threshold',
  AssociationFPConfidence: 'Confidence Threshold',
  AssociationFPSupportHint: 'Min appearance of antecedant set',
  AssociationFPConfidenceHint: 'confidence（{x→y}）= transactions containing both x and y / transactions containing x',
  AssociationViewTitle: 'Within Groups Sum of Squares',
  summaryRow1: 'average length',
  summaryRow2: 'max length',
  summaryRow3: 'min length',
  summaryRow4: 'total items',
  summaryRow5: 'total transaction/users',
  AssociateRules: 'Associate rules',
  ...
  CannotCreatePmml: 'Cannot be Created',
};
