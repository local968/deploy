...
export default function (location) {
  ...
  function tip(vis) {
    ...
    document.querySelector(location).parentElement.appendChild(node);
  }
  ...
  tip.show = function () {
    ...
    nodel.classed(dir, true)
      .style('top', (poffset[0]) + 'px')
      .style('left', (poffset[1]) + 'px');
  ...
  function initNode(initNode) {
    let node = d3.select(initNode);
    node
      .style('position', 'absolute')
      .style('top', 0)
      .style('opacity', 0)
