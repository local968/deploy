...
class Report extends Component<Interface> {
  ...
  render() {
    ...
    console.log(
      Object.keys(list[0].colType).values(),
      'Object.keys(list[0].colType)',
      Object.keys(list[0].colType).filter(([k, v]) => {
        console.log(v, 'ccccccccc', k);
      }),
    );
      ...
      <div className={styles.report}>
            ...
            <div className={styles.schema}>
              ...
              <div className={styles.schemaRow}>
                <span className={styles.schemaCell}>
                  {addComma(list[0].totalRawLines)}
                </span>
                <span className={styles.schemaCell}>
                  {addComma(Object.keys(list[0].colType).length)}
                </span>
                <span className={styles.schemaCell}>
        ...
        {this.isShow('dataAnalysis') && (
          <div className={styles.block}>
            ...
            {list[0].informativesLabel.length > 0 ? (
              <div>
        ...
        <div className={styles.modelResult}>
          ...
          {this.isShow('metrics') && (
            <div className={classnames(styles.block, styles.VariableImpact)}>
              ...
              {list[0].problemType === 'Classification' && (
                <div className={styles.metrics}>
                  <div
                    className={classnames(
                      styles.metricsRow,
