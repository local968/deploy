...
export default class VariableList extends Component {
  ...
  render() {
    const { project } = this.props;
    const {
      target, colType, targetMap, dataViews, dataViewsLoading, preImportance, preImportanceLoading,
      dataHeader, addNewVariable2, newVariable, newType, newVariableViews,
    ...
    return <div className={styles.simplified} style={{ zIndex: this.visible ? 3 : 1 }}>
      <div className={styles.targetTable}>
        ...
        <div className={styles.targetRow}>
          <div className={classnames(styles.targetCell, styles.targetName)} title={newMapHeader[target]}>
            <span>{newMapHeader[target]}</span></div>
