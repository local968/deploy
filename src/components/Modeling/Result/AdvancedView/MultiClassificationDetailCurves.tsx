...
interface MultiClassificationDetailCurvesProps {
  project: Project;
  model: Model;
...
@observer
class MultiClassificationDetailCurves extends Component<MultiClassificationDetailCurvesProps> {
  state = {
...
export default MultiClassificationDetailCurves;
