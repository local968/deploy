...
export default class AdvancedView extends Component<AdvancedViewProps> {
  ...
  changeCrossCount = value => {
    ...
    if (value >= crossCountMax) {
      ...
      return message.error(
        `${EN.Oneoftheclasseshasnumber} ${crossCountMax} ${EN.Pleaseselectalowerfoldcv}`,
      );
    }
  ...
  handleRunWith = v => {
    if (v === 'holdout') {
      ...
      if (validationRate + holdoutRate > 99) {
        ...
        this.props.setSetting({
          holdoutRate: Math.min(99 - validationRate, 10),
        });
      }
    }
  ...
  crossPercent = () => {
    ...
    for (let i = 0; i < crossCount; i++) {
      arr.push(
        <div
          className={styles.advancedPercentCross}
          style={{ width: percent / crossCount + '%' }}
          key={i}
        />,
      );
    }
  ...
  render() {
      ...
      problemType === 'Classification'
        ...
        : problemType === 'Regression'
          ...
          : [
            ...
            { value: 'macro_recall', label: 'Macro Recall' },
            { value: 'micro_recall', label: 'Micro Recall' },
            { value: 'macro_precision', label: 'Macro Precision' },
            { value: 'micro_precision', label: 'Micro Precision' },
          ];
    ...
    if (problemType !== 'Regression') {
      ...
      if (algorithms.includes('multinomial_nb'))
        featureList = featureList.concat([
          'Extra Trees',
          'Random Trees',
          'Polynomial',
                ...
                <div className={styles.advancedSolution}>
                  <div className={styles.advancedAlgorithm} key={'solution-a'}>
                    ...
                    <input
                      id={'R2-solution-a'}
                      type="checkbox"
                      checked={version.includes(1)}
                      onChange={this.handleSolution.bind(null, 1)}
                    />
                    <label htmlFor={'R2-solution-a'}>
                 ...
                 <Tooltip
                  ...
                  <div className={styles.advancedAlgorithm} key={'solution-b'}>
                    ...
                    <input
                      id={'R2-solution-b'}
                      type="checkbox"
                      checked={version.includes(2)}
                      onChange={this.handleSolution.bind(null, 2)}
                    />
                    <label htmlFor={'R2-solution-b'}>
                      <span style={{ color: 'red', margin: '0 4px' }}>*</span>
                      R2-solution-b
                    </label>
                  </div>
                ...
                {problemType !== 'MultiClassification' && (
                  <div className={styles.advancedAlgorithm} key={'solution-d'}>
                    ...
                    <input
                      id={'R2-solution-d'}
                      type="checkbox"
                      checked={version.includes(4)}
                      onChange={this.handleSolution.bind(null, 4)}
                    />
              ...
              <div className={styles.advancedOption}>
                <div className={styles.advancedOptionBox}>
                  <input
                    ...
                    type="radio"
                    name="featuresSelect"
                    checked={features.some(fe => featureList.includes(fe))}
                    onClick={this.handleFeaturesAll.bind(null, true)}
                    readOnly
                  />
                ...
                <div className={styles.advancedOptionBox}>
                  <input
                    ...
                    name="featuresSelect"
                    checked={!features.some(fe => featureList.includes(fe))}
                    onClick={this.handleFeaturesAll.bind(null, false)}
                    readOnly
                  />
            ...
            <div className={styles.advancedBlock}>
              <div className={styles.advancedAlgorithmList}>
                {Feature.map((v, k) => {
                  ...
                  return (
                    <div
                      className={classnames(styles.advancedAlgorithm, {
              ...
              <div className={styles.advancedLine}>
                ...
                <div className={styles.advancedOptionBox}>
                  <input
                    ...
                    type="radio"
                    name="resampling"
                    checked={resampling === 'up'}
                    onChange={this.handleResampling.bind(null, 'up')}
                  />
                ...
                <div className={styles.advancedOptionBox}>
                  <input
                    ...
                    type="radio"
                    name="resampling"
                    checked={resampling === 'down'}
                    onChange={this.handleResampling.bind(null, 'down')}
                  />
                ...
                <div className={styles.advancedOptionBox}>
                  <input
                    ...
                    type="radio"
                    name="resampling"
                    checked={resampling === 'no'}
                    onChange={this.handleResampling.bind(null, 'no')}
                  />
              ...
              <div className={styles.advancedBlock}>
                ...
                <div className={styles.advancedOption}>
                  <Tooltip
                    ...
                    title={
                      <span className={styles.crossWarning}>
                        {EN.Performingcrossvalidation} <br />
                        {EN.Hencewerecommendchoosing}
                      </span>
                    }
                    visible={
                      !hidden && (runWith === 'cross' && totalLines > 200000)
                    }
                    overlayStyle={{ maxWidth: '100%' }}
                  >
                    <div className={styles.advancedOptionBox}>
                      <input
                        ...
                        type="radio"
                        name="runWith"
                        checked={runWith === 'cross'}
                        onChange={this.handleRunWith.bind(null, 'cross')}
                      />
                  ...
                  <div className={styles.advancedOptionBox}>
                    <input
                      ...
                      type="radio"
                      name="runWith"
                      checked={runWith === 'holdout'}
                      onChange={this.handleRunWith.bind(null, 'holdout')}
                    />
                    <label htmlFor="runwith2">
                      {EN.TrainValidationHoldout}
                    </label>
                  </div>
                </div>
              </div>
                    ...
                    <div className={styles.advancedPercentBlock}>
                      <div className={styles.advancedPercent}>
                        <div
                          ...
                          style={{
                            width: 100 - validationRate - holdoutRate + '%',
                          }}
                        ></div>
                        <div
                      ...
                      <div className={styles.advancedPercentInput}>
                        <div className={styles.advancedPercentText}>
                          <div
                            className={classnames(
                              styles.advancedPercetColor,
                              styles.advancedPercentValidation,
                            )}
                          />
            ...
            <div className={styles.advancedSpeed}>
              <div className={styles.advancedBox}>
                <div className={styles.advancedTitle}>
                  <span>
                    {EN.SpeedVSAccuracy}:
                    <a className={styles.reset} onClick={this.resetSpeed}>
                      {EN.Reset}
                    </a>
                  </span>
                </div>
                <div className={styles.advancedPercentBlock}>
                  <div className={styles.advancedPercent}>
                    <div
                      className={styles.advancedPercentCross}
                      style={{ width: ((speedVSaccuracy - 1) / 8) * 100 + '%' }}
                    />
                    <div
                      className={styles.advancedPercentHoldout}
                      style={{ width: ((9 - speedVSaccuracy) / 8) * 100 + '%' }}
                    />
                  </div>
                  <Range
                    range={false}
                ...
                <div className={styles.advancedPercentBox}>
                  <div className={styles.advancedPercentInput}>
                    ...
                    <NumberInput
                      value={speedVSaccuracy}
                      onBlur={this.changeSpeed.bind(null, true)}
                      min={1}
                      max={9}
                      isInt={true}
                    />
                  ...
                  <div className={styles.advancedPercentInput}>
                    ...
                    <NumberInput
                      value={10 - speedVSaccuracy}
                      onBlur={this.changeSpeed.bind(null, false)}
                      min={1}
                      max={9}
                      isInt={true}
                    />
