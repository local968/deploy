            ...
            <div className={styles.advancedAlgorithmList}>
              <Tooltip
                ...
                <div className={styles.advancedAlgorithm} key={'solution-a'}>
                  ...
                  <input id={'R2-solution-a'} type='checkbox' checked={version.includes(1)} onClick={this.handleSolution.bind(1)} />
              ...
              <Tooltip
                ...
                <div className={styles.advancedAlgorithm} key={'solution-b'}>
                  ...
                  <input id={'R2-solution-b'} type='checkbox' checked={version.includes(2)}  onClick={this.handleSolution.bind(2)} />
